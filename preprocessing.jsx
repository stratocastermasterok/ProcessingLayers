...
//part 2 to create the reduced list of "real" values
    ...
    for (ii=0; ii< (myString2.length-1); ii++)
       ...
       // alert(streamlined);
        ...
        var myScaleValues = selectedLayers[0].property("scale");
        ...
        {
            scaleValues = scaleValues.keyValue(i);
            myScaleValues.removeKey(i);
        }
        ...
        //creating the keyframes on scale
            for (y=0; y< streamlined.length; y++)
            {
                ...
                selectedLayers[0].property("scale").setValueAtTime(myArray1[0],[myArray1[1],myArray1[1]]);
                var changed=0;
                ...
                if (y<(streamlined.length-1))
                {
                    ...
                    selectedLayers[0].property("scale").setValueAtTime(myArray2[0]-(4/30),[myArray1[1],myArray1[1]]);
...
// setting the dynamic easing values
            for (gg = 1; gg< myScaleValues.numKeys+1; gg+=2)
            {
